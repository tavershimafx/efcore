    ...
    internal partial class DependentBaseEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var principalId = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw,
                sentinel: 0L);
            principalId.SetPropertyIndexes(new(
                index: 0,
            ...
            var principalAlternateId = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw,
                sentinel: new Guid("00000000-0000-0000-0000-000000000000"));
            principalAlternateId.SetPropertyIndexes(new(
                index: 1,
            ...
            enumDiscriminator.SetPropertyIndexes(new(
                index: 2,
            ...
            enumDiscriminator.TypeMapping = IntTypeMapping.Default.Clone(
                ...
                jsonValueReaderWriter: new JsonConvertedValueReaderWriter<CSharpMigrationsGeneratorTest.Enum1, int>(
                    ...
                    new ValueConverter<CSharpMigrationsGeneratorTest.Enum1, int>(
                        (CSharpMigrationsGeneratorTest.Enum1 value) => (int)value,
                        (int value) => (CSharpMigrationsGeneratorTest.Enum1)value)));
            enumDiscriminator.SetCurrentValueComparer(new EntryCurrentValueComparer<CSharpMigrationsGeneratorTest.Enum1>(enumDiscriminator));
            ...
            var id = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            id.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.DependentBase<Nullable<byte>> entity) => ReadId(entity),
                (CSharpRuntimeModelCodeGeneratorTest.DependentBase<Nullable<byte>> entity) => !ReadId(entity).HasValue);
            id.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.DependentBase<Nullable<byte>> entity, Nullable<byte> value) => WriteId(entity, value));
            id.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.DependentBase<Nullable<byte>> entity, Nullable<byte> value) => WriteId(entity, value));
            id.SetAccessors(
                (IInternalEntry entry) => ReadId((CSharpRuntimeModelCodeGeneratorTest.DependentBase<Nullable<byte>>)entry.Object),
                (IInternalEntry entry) => ReadId((CSharpRuntimeModelCodeGeneratorTest.DependentBase<Nullable<byte>>)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<Nullable<byte>>(id, 3),
                (InternalEntityEntry entry) => entry.GetCurrentValue<Nullable<byte>>(id),
                (ValueBuffer valueBuffer) => valueBuffer[3]);
            id.SetPropertyIndexes(new(
                index: 3,
        ...
        public static RuntimeForeignKey CreateForeignKey2(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            principal.SetPropertyIndexes(new(
                index: 0,
                originalValueIndex: -1,
                shadowIndex: -1,
                relationshipIndex: 2,
            ...
            dependent.SetPropertyIndexes(new(
                index: 2,
                originalValueIndex: -1,
                shadowIndex: -1,
                relationshipIndex: 4,
        ...
        extern static ref byte? GetId(CSharpRuntimeModelCodeGeneratorTest.DependentBase<byte?> @this);

        private static byte? ReadId(CSharpRuntimeModelCodeGeneratorTest.DependentBase<byte?> @this)
            => GetId(@this);

        private static void WriteId(CSharpRuntimeModelCodeGeneratorTest.DependentBase<byte?> @this, byte? value)
            => GetId(@this) = value;
    }
}
""", c),
    ...
    internal partial class PrincipalBaseEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var id = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw);
            id.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => ReadId(entity),
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => !ReadId(entity).HasValue);
            id.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, Nullable<long> value) => WriteId(entity, value));
            id.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, Nullable<long> value) => WriteId(entity, value));
            id.SetAccessors(
                (IInternalEntry entry) => entry.FlaggedAsStoreGenerated(0) ? entry.ReadStoreGeneratedValue<Nullable<long>>(0) : entry.FlaggedAsTemporary(0) && !ReadId((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object).HasValue ? entry.ReadTemporaryValue<Nullable<long>>(0) : ReadId((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => ReadId((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<Nullable<long>>(id, 0),
            ...
            alternateId.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => entity.AlternateId,
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => entity.AlternateId == new Guid("00000000-0000-0000-0000-000000000000"));
            alternateId.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, Guid value) => entity.AlternateId = value);
            alternateId.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, Guid value) => entity.AlternateId = value);
            alternateId.SetAccessors(
                (IInternalEntry entry) => entry.FlaggedAsStoreGenerated(1) ? entry.ReadStoreGeneratedValue<Guid>(1) : entry.FlaggedAsTemporary(1) && ((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object).AlternateId == new Guid("00000000-0000-0000-0000-000000000000") ? entry.ReadTemporaryValue<Guid>(1) : ((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object).AlternateId,
                (IInternalEntry entry) => ((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object).AlternateId,
                (IInternalEntry entry) => entry.ReadOriginalValue<Guid>(alternateId, 1),
                (InternalEntityEntry entry) => entry.ReadRelationshipSnapshotValue<Guid>(alternateId, 1),
                (ValueBuffer valueBuffer) => valueBuffer[1]);
            alternateId.SetPropertyIndexes(new(
                index: 1,
                originalValueIndex: 1,
                shadowIndex: -1,
                relationshipIndex: 1,
            ...
            enum1.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => ReadEnum1(entity),
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => object.Equals((object)ReadEnum1(entity), (object)(CSharpRuntimeModelCodeGeneratorTest.AnEnum)0L));
            enum1.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, CSharpRuntimeModelCodeGeneratorTest.AnEnum value) => WriteEnum1(entity, value));
            enum1.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, CSharpRuntimeModelCodeGeneratorTest.AnEnum value) => WriteEnum1(entity, value));
            enum1.SetAccessors(
                (IInternalEntry entry) => ReadEnum1((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => ReadEnum1((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<CSharpRuntimeModelCodeGeneratorTest.AnEnum>(enum1, 2),
                (InternalEntityEntry entry) => entry.GetCurrentValue<CSharpRuntimeModelCodeGeneratorTest.AnEnum>(enum1),
                (ValueBuffer valueBuffer) => valueBuffer[2]);
            enum1.SetPropertyIndexes(new(
                index: 2,
                originalValueIndex: 2,
                shadowIndex: -1,
                relationshipIndex: -1,
            ...
            enum1.TypeMapping = IntTypeMapping.Default.Clone(
                ...
                jsonValueReaderWriter: new JsonConvertedValueReaderWriter<CSharpRuntimeModelCodeGeneratorTest.AnEnum, int>(
                    ...
                    new ValueConverter<CSharpRuntimeModelCodeGeneratorTest.AnEnum, int>(
                        (CSharpRuntimeModelCodeGeneratorTest.AnEnum value) => (int)value,
                        (int value) => (CSharpRuntimeModelCodeGeneratorTest.AnEnum)value)));
            enum1.SetCurrentValueComparer(new EntryCurrentValueComparer<CSharpRuntimeModelCodeGeneratorTest.AnEnum>(enum1));
            ...
            var enum2 = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            enum2.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => ReadEnum2(entity),
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => !ReadEnum2(entity).HasValue);
            enum2.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, Nullable<CSharpRuntimeModelCodeGeneratorTest.AnEnum> value) => WriteEnum2(entity, value));
            enum2.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, Nullable<CSharpRuntimeModelCodeGeneratorTest.AnEnum> value) => WriteEnum2(entity, value));
            enum2.SetAccessors(
                (IInternalEntry entry) => ReadEnum2((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => ReadEnum2((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<Nullable<CSharpRuntimeModelCodeGeneratorTest.AnEnum>>(enum2, 3),
                (InternalEntityEntry entry) => entry.GetCurrentValue<Nullable<CSharpRuntimeModelCodeGeneratorTest.AnEnum>>(enum2),
                (ValueBuffer valueBuffer) => valueBuffer[3]);
            enum2.SetPropertyIndexes(new(
                index: 3,
                originalValueIndex: 3,
                shadowIndex: -1,
                relationshipIndex: -1,
            ...
            enum2.TypeMapping = IntTypeMapping.Default.Clone(
                ...
                jsonValueReaderWriter: new JsonConvertedValueReaderWriter<CSharpRuntimeModelCodeGeneratorTest.AnEnum, int>(
                    ...
                    new ValueConverter<CSharpRuntimeModelCodeGeneratorTest.AnEnum, int>(
                        (CSharpRuntimeModelCodeGeneratorTest.AnEnum value) => (int)value,
                        (int value) => (CSharpRuntimeModelCodeGeneratorTest.AnEnum)value)));
            enum2.SetCurrentValueComparer(new EntryCurrentValueComparer<CSharpRuntimeModelCodeGeneratorTest.AnEnum?>(enum2));
            ...
            flagsEnum1.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => ReadFlagsEnum1(entity),
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => object.Equals((object)ReadFlagsEnum1(entity), (object)(CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum)0L));
            flagsEnum1.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value) => WriteFlagsEnum1(entity, value));
            flagsEnum1.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value) => WriteFlagsEnum1(entity, value));
            flagsEnum1.SetAccessors(
                (IInternalEntry entry) => ReadFlagsEnum1((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => ReadFlagsEnum1((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum>(flagsEnum1, 4),
                (InternalEntityEntry entry) => entry.GetCurrentValue<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum>(flagsEnum1),
                (ValueBuffer valueBuffer) => valueBuffer[4]);
            flagsEnum1.SetPropertyIndexes(new(
                index: 4,
            ...
            flagsEnum1.TypeMapping = IntTypeMapping.Default.Clone(
                ...
                jsonValueReaderWriter: new JsonConvertedValueReaderWriter<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum, int>(
                    ...
                    new ValueConverter<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum, int>(
                        (CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value) => (int)value,
                        (int value) => (CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum)value)));
            flagsEnum1.SetCurrentValueComparer(new EntryCurrentValueComparer<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum>(flagsEnum1));
            ...
            flagsEnum2.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => ReadFlagsEnum2(entity),
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity) => object.Equals((object)ReadFlagsEnum2(entity), (object)(CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum)6L));
            flagsEnum2.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value) => WriteFlagsEnum2(entity, value));
            flagsEnum2.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.PrincipalBase entity, CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value) => WriteFlagsEnum2(entity, value));
            flagsEnum2.SetAccessors(
                (IInternalEntry entry) => ReadFlagsEnum2((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => ReadFlagsEnum2((CSharpRuntimeModelCodeGeneratorTest.PrincipalBase)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum>(flagsEnum2, 5),
                (InternalEntityEntry entry) => entry.GetCurrentValue<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum>(flagsEnum2),
                (ValueBuffer valueBuffer) => valueBuffer[5]);
            flagsEnum2.SetPropertyIndexes(new(
                index: 5,
            ...
            flagsEnum2.TypeMapping = IntTypeMapping.Default.Clone(
                ...
                jsonValueReaderWriter: new JsonConvertedValueReaderWriter<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum, int>(
                    ...
                    new ValueConverter<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum, int>(
                        (CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value) => (int)value,
                        (int value) => (CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum)value)));
            flagsEnum2.SetCurrentValueComparer(new EntryCurrentValueComparer<CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum>(flagsEnum2));
            ...
            point.SetCurrentValueComparer(new EntryCurrentValueComparer<Point>(point));
        ...
        [UnsafeAccessor(UnsafeAccessorKind.Field, Name = "<Id>k__BackingField")]
        extern static ref long? GetId(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this);

        private static long? ReadId(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this)
            => GetId(@this);

        private static void WriteId(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this, long? value)
            => GetId(@this) = value;

        [UnsafeAccessor(UnsafeAccessorKind.Field, Name = "<Enum1>k__BackingField")]
        extern static ref CSharpRuntimeModelCodeGeneratorTest.AnEnum GetEnum1(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this);

        private static CSharpRuntimeModelCodeGeneratorTest.AnEnum ReadEnum1(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this)
            => GetEnum1(@this);

        private static void WriteEnum1(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this, CSharpRuntimeModelCodeGeneratorTest.AnEnum value)
            => GetEnum1(@this) = value;

        [UnsafeAccessor(UnsafeAccessorKind.Field, Name = "<Enum2>k__BackingField")]
        extern static ref CSharpRuntimeModelCodeGeneratorTest.AnEnum? GetEnum2(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this);

        private static CSharpRuntimeModelCodeGeneratorTest.AnEnum? ReadEnum2(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this)
            => GetEnum2(@this);

        private static void WriteEnum2(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this, CSharpRuntimeModelCodeGeneratorTest.AnEnum? value)
            => GetEnum2(@this) = value;

        [UnsafeAccessor(UnsafeAccessorKind.Field, Name = "<FlagsEnum1>k__BackingField")]
        extern static ref CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum GetFlagsEnum1(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this);

        private static CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum ReadFlagsEnum1(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this)
            => GetFlagsEnum1(@this);

        private static void WriteFlagsEnum1(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this, CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value)
            => GetFlagsEnum1(@this) = value;

        [UnsafeAccessor(UnsafeAccessorKind.Field, Name = "<FlagsEnum2>k__BackingField")]
        extern static ref CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum GetFlagsEnum2(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this);

        private static CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum ReadFlagsEnum2(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this)
            => GetFlagsEnum2(@this);

        private static void WriteFlagsEnum2(CSharpRuntimeModelCodeGeneratorTest.PrincipalBase @this, CSharpRuntimeModelCodeGeneratorTest.AFlagsEnum value)
    ...
    internal partial class OwnedTypeEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var principalBaseId = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw,
                sentinel: 0L);
            principalBaseId.SetPropertyIndexes(new(
                index: 0,
                originalValueIndex: 0,
                shadowIndex: 0,
                relationshipIndex: 0,
            ...
            var principalBaseAlternateId = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw,
                sentinel: new Guid("00000000-0000-0000-0000-000000000000"));
            principalBaseAlternateId.SetPropertyIndexes(new(
                index: 1,
                originalValueIndex: 1,
                shadowIndex: 1,
                relationshipIndex: 1,
            ...
            var details = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            details.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity) => ReadDetails(entity),
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity) => ReadDetails(entity) == null);
            details.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity, string value) => WriteDetails(entity, value));
            details.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity, string value) => WriteDetails(entity, value));
            details.SetAccessors(
                (IInternalEntry entry) => ReadDetails((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => ReadDetails((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<string>(details, 2),
                (InternalEntityEntry entry) => entry.GetCurrentValue<string>(details),
                (ValueBuffer valueBuffer) => valueBuffer[2]);
            details.SetPropertyIndexes(new(
                index: 2,
                originalValueIndex: 2,
                shadowIndex: -1,
                relationshipIndex: -1,
            ...
            details.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    ...
                    dbType: System.Data.DbType.String),
                storeTypePostfix: StoreTypePostfix.None);
            details.SetCurrentValueComparer(new EntryCurrentValueComparer<string>(details));
            ...
            var number = runtimeEntityType.AddProperty(
                ...
                sentinel: 0);
            number.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity) => ReadNumber(entity),
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity) => ReadNumber(entity) == 0);
            number.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity, int value) => WriteNumber(entity, value));
            number.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.OwnedType entity, int value) => WriteNumber(entity, value));
            number.SetAccessors(
                (IInternalEntry entry) => ReadNumber((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => ReadNumber((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<int>(number, 3),
                (InternalEntityEntry entry) => entry.GetCurrentValue<int>(number),
                (ValueBuffer valueBuffer) => valueBuffer[3]);
            number.SetPropertyIndexes(new(
                index: 3,
                originalValueIndex: 3,
                shadowIndex: -1,
                relationshipIndex: -1,
            ...
            number.TypeMapping = IntTypeMapping.Default.Clone(
                ...
                providerValueComparer: new ValueComparer<int>(
                    ...
                    (int v) => v,
                    (int v) => v));
            number.SetCurrentValueComparer(new EntryCurrentValueComparer<int>(number));
            ...
            context.SetPropertyIndexes(new(
                index: -1,
                originalValueIndex: -1,
                shadowIndex: -1,
                relationshipIndex: -1,
        ...
        extern static ref string GetDetails(CSharpRuntimeModelCodeGeneratorTest.OwnedType @this);

        private static string ReadDetails(CSharpRuntimeModelCodeGeneratorTest.OwnedType @this)
            => GetDetails(@this);

        private static void WriteDetails(CSharpRuntimeModelCodeGeneratorTest.OwnedType @this, string value)
            => GetDetails(@this) = value;

        [UnsafeAccessor(UnsafeAccessorKind.Field, Name = "<Number>k__BackingField")]
        extern static ref int GetNumber(CSharpRuntimeModelCodeGeneratorTest.OwnedType @this);

        private static int ReadNumber(CSharpRuntimeModelCodeGeneratorTest.OwnedType @this)
            => GetNumber(@this);

        private static void WriteNumber(CSharpRuntimeModelCodeGeneratorTest.OwnedType @this, int value)
    ...
    internal partial class OwnedType0EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var principalDerivedId = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw,
                sentinel: 0L);
            principalDerivedId.SetPropertyIndexes(new(
                index: 0,
                originalValueIndex: 0,
                shadowIndex: 0,
                relationshipIndex: 0,
            ...
            var principalDerivedAlternateId = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw,
                sentinel: new Guid("00000000-0000-0000-0000-000000000000"));
            principalDerivedAlternateId.SetPropertyIndexes(new(
                index: 1,
                originalValueIndex: 1,
                shadowIndex: 1,
                relationshipIndex: 1,
            ...
            details.SetAccessors(
                (IInternalEntry entry) => ReadDetails((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => ReadDetails((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<string>(details, 3),
                (InternalEntityEntry entry) => entry.GetCurrentValue<string>(details),
                (ValueBuffer valueBuffer) => valueBuffer[3]);
            details.SetPropertyIndexes(new(
                index: 3,
            ...
            number.SetAccessors(
                (IInternalEntry entry) => ReadNumber((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => ReadNumber((CSharpRuntimeModelCodeGeneratorTest.OwnedType)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<int>(number, 4),
                (InternalEntityEntry entry) => entry.GetCurrentValue<int>(number),
                (ValueBuffer valueBuffer) => valueBuffer[4]);
            number.SetPropertyIndexes(new(
                index: 4,
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            manyOwned.SetPropertyIndexes(new(
                index: 3,
                originalValueIndex: -1,
                shadowIndex: -1,
                relationshipIndex: 5,
        ...
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            derivedsId.SetAccessors(
                (IInternalEntry entry) =>
                {
                    ...
                    {
                        {
                            if (entry.FlaggedAsTemporary(0) && (((Dictionary<string, object>)entry.Object).ContainsKey("DerivedsId") ? ((Dictionary<string, object>)entry.Object)["DerivedsId"] : null) == null)
                            {
                                return entry.ReadTemporaryValue<long>(0);
                            }
                            else
                            {
                                var nullableValue = ((Dictionary<string, object>)entry.Object).ContainsKey("DerivedsId") ? ((Dictionary<string, object>)entry.Object)["DerivedsId"] : null;
                ...
                (IInternalEntry entry) => entry.ReadOriginalValue<long>(derivedsId, 0),
                (InternalEntityEntry entry) => entry.ReadRelationshipSnapshotValue<long>(derivedsId, 0),
                (ValueBuffer valueBuffer) => valueBuffer[0]);
            derivedsId.SetPropertyIndexes(new(
                index: 0,
                originalValueIndex: 0,
                shadowIndex: -1,
                relationshipIndex: 0,
            ...
            derivedsAlternateId.SetAccessors(
                (IInternalEntry entry) =>
                {
                    ...
                    {
                        {
                            if (entry.FlaggedAsTemporary(1) && (((Dictionary<string, object>)entry.Object).ContainsKey("DerivedsAlternateId") ? ((Dictionary<string, object>)entry.Object)["DerivedsAlternateId"] : null) == null)
                            {
                                return entry.ReadTemporaryValue<Guid>(1);
                            }
                            else
                            {
                                var nullableValue = ((Dictionary<string, object>)entry.Object).ContainsKey("DerivedsAlternateId") ? ((Dictionary<string, object>)entry.Object)["DerivedsAlternateId"] : null;
                ...
                (IInternalEntry entry) => entry.ReadOriginalValue<Guid>(derivedsAlternateId, 1),
                (InternalEntityEntry entry) => entry.ReadRelationshipSnapshotValue<Guid>(derivedsAlternateId, 1),
                (ValueBuffer valueBuffer) => valueBuffer[1]);
            derivedsAlternateId.SetPropertyIndexes(new(
                index: 1,
                originalValueIndex: 1,
                shadowIndex: -1,
                relationshipIndex: 1,
            ...
            principalsId.SetAccessors(
                (IInternalEntry entry) =>
                {
                    ...
                    {
                        {
                            if (entry.FlaggedAsTemporary(2) && (((Dictionary<string, object>)entry.Object).ContainsKey("PrincipalsId") ? ((Dictionary<string, object>)entry.Object)["PrincipalsId"] : null) == null)
                            {
                                return entry.ReadTemporaryValue<long>(2);
                            }
                            else
                            {
                                var nullableValue = ((Dictionary<string, object>)entry.Object).ContainsKey("PrincipalsId") ? ((Dictionary<string, object>)entry.Object)["PrincipalsId"] : null;
                                return nullableValue == null ? default(long) : (long)nullableValue;
                            }
                        }
                    }
                ...
                (IInternalEntry entry) => entry.ReadOriginalValue<long>(principalsId, 2),
                (InternalEntityEntry entry) => entry.ReadRelationshipSnapshotValue<long>(principalsId, 2),
                (ValueBuffer valueBuffer) => valueBuffer[2]);
            principalsId.SetPropertyIndexes(new(
                index: 2,
                originalValueIndex: 2,
                shadowIndex: -1,
                relationshipIndex: 2,
            ...
            principalsAlternateId.SetAccessors(
                (IInternalEntry entry) =>
                {
                    ...
                    {
                        {
                            if (entry.FlaggedAsTemporary(3) && (((Dictionary<string, object>)entry.Object).ContainsKey("PrincipalsAlternateId") ? ((Dictionary<string, object>)entry.Object)["PrincipalsAlternateId"] : null) == null)
                            {
                                return entry.ReadTemporaryValue<Guid>(3);
                            }
                            else
                            {
                                var nullableValue = ((Dictionary<string, object>)entry.Object).ContainsKey("PrincipalsAlternateId") ? ((Dictionary<string, object>)entry.Object)["PrincipalsAlternateId"] : null;
                                return nullableValue == null ? default(Guid) : (Guid)nullableValue;
                            }
                        }
                    }
                ...
                (IInternalEntry entry) => entry.ReadOriginalValue<Guid>(principalsAlternateId, 3),
                (InternalEntityEntry entry) => entry.ReadRelationshipSnapshotValue<Guid>(principalsAlternateId, 3),
                (ValueBuffer valueBuffer) => valueBuffer[3]);
            principalsAlternateId.SetPropertyIndexes(new(
                index: 3,
                originalValueIndex: 3,
                shadowIndex: -1,
                relationshipIndex: 3,
            ...
            rowid.SetMaterializationSetter(
                (Dictionary<string, object> entity, Byte[] value) => entity["rowid"] = (object)value);
            rowid.SetAccessors(
                (IInternalEntry entry) => entry.FlaggedAsStoreGenerated(4) ? entry.ReadStoreGeneratedValue<Byte[]>(4) : entry.FlaggedAsTemporary(4) && (((Dictionary<string, object>)entry.Object).ContainsKey("rowid") ? ((Dictionary<string, object>)entry.Object)["rowid"] : null) == null ? entry.ReadTemporaryValue<Byte[]>(4) : (Byte[])(((Dictionary<string, object>)entry.Object).ContainsKey("rowid") ? ((Dictionary<string, object>)entry.Object)["rowid"] : null),
                (IInternalEntry entry) => (Byte[])(((Dictionary<string, object>)entry.Object).ContainsKey("rowid") ? ((Dictionary<string, object>)entry.Object)["rowid"] : null),
                (IInternalEntry entry) => entry.ReadOriginalValue<Byte[]>(rowid, 4),
                (InternalEntityEntry entry) => entry.GetCurrentValue<Byte[]>(rowid),
                (ValueBuffer valueBuffer) => valueBuffer[4]);
            rowid.SetPropertyIndexes(new(
                index: 4,
                originalValueIndex: 4,
                shadowIndex: -1,
                relationshipIndex: -1,
            ...
            rowid.TypeMapping = SqlServerByteArrayTypeMapping.Default.Clone(
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    ...
                    size: 8),
                storeTypePostfix: StoreTypePostfix.None);
            rowid.SetCurrentValueComparer(new StructuralEntryCurrentValueComparer(rowid));
    ...
    internal partial class DependentDerivedEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var data = runtimeEntityType.AddProperty(
                ...
                unicode: false);
            data.SetGetter(
                (CSharpRuntimeModelCodeGeneratorTest.DependentDerived<Nullable<byte>> entity) => ReadData(entity),
                (CSharpRuntimeModelCodeGeneratorTest.DependentDerived<Nullable<byte>> entity) => ReadData(entity) == null);
            data.SetSetter(
                (CSharpRuntimeModelCodeGeneratorTest.DependentDerived<Nullable<byte>> entity, string value) => WriteData(entity, value));
            data.SetMaterializationSetter(
                (CSharpRuntimeModelCodeGeneratorTest.DependentDerived<Nullable<byte>> entity, string value) => WriteData(entity, value));
            data.SetAccessors(
                (IInternalEntry entry) => ReadData((CSharpRuntimeModelCodeGeneratorTest.DependentDerived<Nullable<byte>>)entry.Object),
                (IInternalEntry entry) => ReadData((CSharpRuntimeModelCodeGeneratorTest.DependentDerived<Nullable<byte>>)entry.Object),
                (IInternalEntry entry) => entry.ReadOriginalValue<string>(data, 4),
                (InternalEntityEntry entry) => entry.GetCurrentValue<string>(data),
                (ValueBuffer valueBuffer) => valueBuffer[4]);
            data.SetPropertyIndexes(new(
                index: 4,
                originalValueIndex: 4,
                shadowIndex: -1,
                relationshipIndex: -1,
            ...
            data.SetCurrentValueComparer(new EntryCurrentValueComparer<string>(data));
            ...
            money.TypeMapping = SqlServerDecimalTypeMapping.Default.Clone(
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    ...
                    precision: 9,
                    scale: 3));
            money.SetCurrentValueComparer(new EntryCurrentValueComparer<decimal>(money));
        ...
        extern static ref string GetData(CSharpRuntimeModelCodeGeneratorTest.DependentDerived<byte?> @this);

        private static string ReadData(CSharpRuntimeModelCodeGeneratorTest.DependentDerived<byte?> @this)
            => GetData(@this);

        private static void WriteData(CSharpRuntimeModelCodeGeneratorTest.DependentDerived<byte?> @this, string value)
            => GetData(@this) = value;
    }
}
""", c),
...
""", c)),
                model =>
                {
                    ...
                    Assert.Equal(joinTable.Name, joinTable.Name);
                            ...
                            .UsingEntity(
                                jb =>
                                {
                                    jb.ToTable(tb =>
                                    {
                                        ...
                                        tb.IsMemoryOptimized().ExcludeFromMigrations();
                                    });
