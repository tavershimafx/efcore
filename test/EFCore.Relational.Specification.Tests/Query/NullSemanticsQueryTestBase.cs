    ...
    where TFixture : NullSemanticsQueryFixtureBase, new()
{
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Like_on_nullable_string_in_predicate(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where EF.Functions.Like(e.NullableStringA, "Foo")
                  select e.Id,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where e.NullableStringA == "Foo"
                  select e.Id);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Like_on_nullable_string_negated_in_predicate(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where !EF.Functions.Like(e.NullableStringA, "Foo")
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Like_on_nullable_string_in_projection(bool async)
        => AssertQuery(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  select new { e.Id, Like = (bool?)EF.Functions.Like(e.NullableStringA, "Foo") },
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  select new { e.Id, Like = (bool?)(e.NullableStringA == "Foo") },
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
                Assert.Equal(e.Like, a.Like);
            });

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Like_on_nullable_string_negated_in_projection(bool async)
        => AssertQuery(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  select new { e.Id, Like = !EF.Functions.Like(e.NullableStringA, "Foo") },
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  select new { e.Id, Like = !(e.NullableStringA == "Foo") },
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task OrderBy_like_on_nullable_string(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  orderby EF.Functions.Like(e.NullableStringA, "Foo"), e.Id
                  select e.Id,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  orderby (e.NullableStringA == "Foo"), e.Id
                  select e.Id,
            assertOrder: true);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task OrderBy_like_on_nullable_string_negated(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  orderby !EF.Functions.Like(e.NullableStringA, "Foo"), e.Id
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task OrderByDescending_like_on_nullable_string(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  orderby EF.Functions.Like(e.NullableStringA, "Foo"), e.Id
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task OrderByDescending_like_on_nullable_string_negated(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  orderby !EF.Functions.Like(e.NullableStringA, "Foo"), e.Id
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Complex_predicate_with_like_with_bitwise_and(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where (((EF.Functions.Like(e.NullableStringA, "Foo") || e.BoolA) & e.NullableStringB != null)) != false
                  select e.Id,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where (((e.NullableStringA == "Foo") || e.BoolA) & e.NullableStringB != null) != false
                  select e.Id);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Complex_predicate_with_like_with_bitwise_and_variation1(bool async)
        => AssertQuery(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where (((e.NullableStringA == "Foo") || e.BoolA) & e.NullableStringB != null) != false
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Kupson333(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where (((EF.Functions.Like(e.NullableStringA, "Foo") || e.BoolA) & e.NullableStringB != null))
                  select e.Id,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where (((e.NullableStringA == "Foo") || e.BoolA) & e.NullableStringB != null)
                  select e.Id);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Kupson4444(bool async)
        => AssertQueryScalar(
            async,
            ss => from e in ss.Set<NullSemanticsEntity1>()
                  where !(((EF.Functions.Like(e.NullableStringA, "Foo") || e.BoolA) & e.NullableStringB != null))
