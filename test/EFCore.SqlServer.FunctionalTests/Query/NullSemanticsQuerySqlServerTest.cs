...
""");
    ...
    public override async Task OrderBy_like_on_nullable_string(bool async)
    {
        await base.OrderBy_like_on_nullable_string(async);
...
""");
    ...
    public override async Task OrderBy_like_on_nullable_string_negated(bool async)
    {
        await base.OrderBy_like_on_nullable_string_negated(async);
...
""");
    ...
    public override async Task OrderByDescending_like_on_nullable_string(bool async)
    {
        await base.OrderByDescending_like_on_nullable_string(async);
...
""");
    ...
    public override async Task OrderByDescending_like_on_nullable_string_negated(bool async)
    {
        await base.OrderByDescending_like_on_nullable_string_negated(async);
