...
""");
  ...
  ""Updates"": [
    ...
    private static readonly MethodInfo ReadBytesMethod = typeof(QueryBugsTest).GetMethod(nameof(ReadBytes))!;
    private static readonly MethodInfo TryReadTokenMethod = typeof(QueryBugsTest).GetMethod(nameof(TryReadToken))!;
    private static readonly MethodInfo AdvanceToFirstElementMethod = typeof(QueryBugsTest).GetMethod(nameof(AdvanceToFirstElement))!;
    ...
    public static Func<Stream, byte[], TEntity> CreateJsonMaterializer<TEntity>(IEntityType entityType)
    {
        ...
        var foo = ExpressionPrinter.Print(materializeLambda);
    ...
    public class Visits
    {
        ...
        //public NetTopologySuite.Geometries.Point GeoJsonLocation { get; set; } = null!;
        public int Count { get; set; }
...
//            while (!reader.Read())
//            {
//                QueryBugsTest.ReadBytes(stream, ref buffer, ref reader);
//            }
