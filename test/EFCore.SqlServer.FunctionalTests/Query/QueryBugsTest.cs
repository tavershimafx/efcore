            ...
            modelBuilder.Entity<Post>().OwnsOne(
                post => post.Metadata, ownedNavigationBuilder =>
                {
                    ...
                    ownedNavigationBuilder.OwnsMany(
                        ...
                        ownedOwnedNavigationBuilder => ownedOwnedNavigationBuilder.OwnsMany(update => update.Commits, xxx => xxx.Property(xxxx => xxxx.Id).HasJsonPropertyName("Id")));
                });
            #endregion
