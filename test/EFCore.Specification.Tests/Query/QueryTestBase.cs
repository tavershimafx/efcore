    ...
    where TFixture : class, IQueryFixtureBase, new()
{
    ...
    public Task AssertQueryScalar<TResult>(
        ...
        => AssertQueryScalar(async, query, query, assertOrder, assertEmpty, testMethodName);
    ...
    public Task AssertQueryScalar<TResult>(
        ...
        [CallerMemberName] string testMethodName = null)
        where TResult : struct
        => QueryAsserter.AssertQueryScalar(actualQuery, expectedQuery, assertOrder, assertEmpty,  async, testMethodName);
