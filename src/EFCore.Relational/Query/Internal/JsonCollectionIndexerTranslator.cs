...
/// </summary>
public class JsonCollectionIndexerTranslator : IMethodCallTranslator
{
    private readonly ISqlExpressionFactory _sqlExpressionFactory;
    //private readonly MethodInfo _listIndexerMethod = typeof(List<int>).GetRuntimeMethod("get_Item", new[] { typeof(string) });
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public JsonCollectionIndexerTranslator(ISqlExpressionFactory sqlExpressionFactory)
    {
